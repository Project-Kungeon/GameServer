...
class C_Register final :
 ...
 public:
  ...
  ~C_Register() override;
  explicit constexpr C_Register(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline C_Register* New() const final {
    return new C_Register();
  }

  C_Register* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class S_Register final :
 ...
 public:
  ...
  ~S_Register() override;
  explicit constexpr S_Register(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline S_Register* New() const final {
    return new S_Register();
  }

  S_Register* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 S_Login::_internal_is_success() const {
  return is_success_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 S_Login::is_success() const {
  // @@protoc_insertion_point(field_get:account.login.S_Login.is_success)
  return _internal_is_success();
}
inline void S_Login::_internal_set_is_success(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  is_success_ = value;
}
inline void S_Login::set_is_success(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline std::string* S_Login::add_fail_message() {
  ...
  return _internal_add_fail_message();
}
...
inline std::string* C_Register::add_confirm_password() {
  ...
  return _internal_add_confirm_password();
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 S_Register::_internal_is_success() const {
  return is_success_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 S_Register::is_success() const {
  // @@protoc_insertion_point(field_get:account.login.S_Register.is_success)
  return _internal_is_success();
}
inline void S_Register::_internal_set_is_success(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  is_success_ = value;
}
inline void S_Register::set_is_success(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_is_success(value);
