...
class C_CharacterList final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR C_CharacterList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  C_CharacterList* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class CharacterInfo final :
 ...
 public:
  ...
  void clear_pk();
  uint64_t pk() const;
  void set_pk(uint64_t value);
  private:
  uint64_t _internal_pk() const;
  void _internal_set_pk(uint64_t value);
  public:
...
class S_CharacterList final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR S_CharacterList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  S_CharacterList* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class C_CreateCharacter final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:account.character.select.C_CreateCharacter) */ {
 public:
  ...
  inline void CopyFrom(const C_CreateCharacter& from) {
...
class S_CreateCharacter final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:account.character.select.S_CreateCharacter) */ {
 public:
...
class S_SelectCharacter final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:account.character.select.S_SelectCharacter) */ {
 public:
  inline S_SelectCharacter() : S_SelectCharacter(nullptr) {}
  explicit PROTOBUF_CONSTEXPR S_SelectCharacter(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  S_SelectCharacter* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<S_SelectCharacter>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const S_SelectCharacter& from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
...
inline uint64_t CharacterInfo::_internal_pk() const {
  return pk_;
}
inline uint64_t CharacterInfo::pk() const {
  // @@protoc_insertion_point(field_get:account.character.select.CharacterInfo.pk)
  return _internal_pk();
}
inline void CharacterInfo::_internal_set_pk(uint64_t value) {
  
  pk_ = value;
}
inline void CharacterInfo::set_pk(uint64_t value) {
...
inline ::account::character::select::CharacterInfo* S_CharacterList::add_character_info_list() {
  ::account::character::select::CharacterInfo* _add = _internal_add_character_info_list();
